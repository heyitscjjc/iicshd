        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-sm offset-">
                                ...
                                @if (Route::has('password.request'))
                                    ...
                                    <p>New User? <a class="btn btn-link" href="/register">Sign Up for an account</a></p>
                                @endif
                            </div>
                        </div>
                    </form>
                    <div>
                        <div class="col-xs-9 ">
                            <img src="{{ asset('img/logo.png') }}" class="pull-right img-responsive" height="400">
                        </div>
                    </div>
                </div>
            </div>
